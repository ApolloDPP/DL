# -*- coding: utf-8 -*-
"""
Created on Thu Jul 13 12:49:39 2020

@author: ApolloDPP
"""

"""
复现image caption中show attend and tell算法
基于pytorch框架
"""
...
class Encoder(nn.Module):
    ...
    def __init__(self, encoded_image_size=14):
        ...
        #使用pytorch中torchvision库里面训练好的VGG16模型
        vgg = torchvision.models.vgg16(pretrained=True) 
        #文中attention是从最后一层特征图中计算，所以将VGG16中后面用于分类的全连接层和softmax层去掉
        modules = list(vgg.children())[:-2]
        self.vgg = nn.Sequential(*modules)
       
        #统一输出的大小（14，14）（输入图像可以任意，保证attention机制算法中特征图大小的统一）
    ...
    #使用VGG16在torchvision库中已经训练好的模型参数
